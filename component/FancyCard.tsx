...
<Text style={styles.cardDiscription}>Technological Surveillance: "Technical eyes" may describe surveillance systems equipped with advanced technology, such as cameras, sensors, or AI algorithms, used for monitoring purposes in various settings like security, traffic managementenvironmental monitong.</Text>
